...
<div class="parcour">
    <div class ="container txtcomp ">
        ...
        <div class ="row">
            <div class= "col-md-12 labelcpt">Parcours</div>
        </div>
        <div class ="row" id="divide2">
        ...
        <div class ="row">
            ...
            <div class= "col-sm-4">
                <ul>
                    <li>Formation Web et Mobile </li>
                    <li>Utilisation de framework (laravel)</li>
                    <li>Approndissement de Language web</li>
                </ul>
            </div>
        </div>

        <div class ="row" id="divide3">
            <div class="col-sm-12"></div>
        </div>
        <div class ="row">
            <div class= "col-md-2">
            ...
            <div class= "col-sm-4">
                <ul>
                    <li>Développement d'un site web interne </li>
                    <li>Enregistrement de profil</li>
                    <li>Affichage de profil avec filtres</li>
                </ul>
            </div>
        </div>
        ...
        <div class ="row">
            ...
            <div class= "col-sm-4">
                <ul>
                    <li>Algorithmie</li>
                    <li>Langage Informatique</li>
                    <li>Méthode de Modélisation de Donnée</li>
                </ul>
            </div>
        </div>
        ...
        <div class ="row">
            ...
            <div class= "col-sm-4">
                <ul>
                    <li>Sécuriser les sites clients</li>
                    <li>Accueil du public Public</li>
                    <li>Résoudre les Problèmes clients</li>
                </ul>
            </div>
        </div>
         ...
         <div class ="row" id="divide3">
          ...
          <div class ="row">
            ...
            <div class= "col-sm-4">
                 <ul>
                    <li>Sécuriser les biens et les personnes </li>
                    <li>Rédaction Rapport et procès-verbaux</li>
